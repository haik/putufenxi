...
def LanczosTri(A1, A2, numiter):
	...
	toff = toff1 + toff2 + toff3 + toff4 + toff5 + toff6 + toff7 + toff8
	ton = ton1 + ton2 + ton3 + ton4 + ton5 + ton6 + ton7 + ton8
	ctr = 0
	for j in range(2, numiter):
		...
		ctr+=1
		toff += toff01 + toff02 + toff03 + toff04 + toff05 + toff06 + toff07 + toff08 + toff09
		ton += ton01 + ton02 + ton03 + ton04 + ton05 + ton06 + ton07 + ton08 + ton09
